...
public class noThirdQuotaMain {
    ...
    public static void main(String[] args) throws IOException, SQLException {
        ...
        for(int i = 1; i <= 5; i++){
            tempFileN = (i -1)*5 + 10;
            //讀取推薦列表
            Map<Integer, List<Integer>> recommentMap = readFile(N,tempFileN);
            printHit(recommentMap,N,tempFileN);
            printPrecision(recommentMap,N,tempFileN);
            printRecall(recommentMap,N,tempFileN);
            printNovelty(recommentMap,N,tempFileN);
            printCoverage(recommentMap,N,tempFileN);
            printILD(recommentMap,N,tempFileN);
            printCoverageAll(recommentMap,N,tempFileN);
            printHD(recommentMap,N,tempFileN);
            printAverageHD(N,tempFileN);
            recommentMap = null;
        }
    }
     ...
     * @throws SQLException
     */
    private static Map<Integer, List<Integer>> readFile(Integer N,Integer fileN) throws IOException{
        Map<Integer, List<Integer>> resultMap = new HashMap<>();
        BufferedReader br = new BufferedReader(new InputStreamReader(new FileInputStream("D:\\OldRecommentAlgorithmWithoutAverage\\1M\\nothird\\resultAgainSortTop"+N+"Len"+fileN+".txt")));
        String data;
        Integer tempUserId;
        String tempMovieIds;
    ...
    private static void printCoverageAll(Map<Integer, List<Integer>> recommentMap,Integer N,Integer fileN) throws IOException, SQLException {
        ...
        FileWriter fwCoverageAll = new FileWriter("D:\\OldRecommentAlgorithmWithoutAverage\\1M\\nothird\\Top"+N+"Len"+fileN+"\\CoverageAll.txt", true);
        fwCoverageAll.write(strCoverageAll.toString());
        fwCoverageAll.close();
    }

    private static void printHit(Map<Integer, List<Integer>> recommentMap,Integer N,Integer fileN) throws IOException, SQLException {
        //計算命中個數
    ...
    private static void printPrecision(Map<Integer, List<Integer>> recommentMap,Integer N,Integer fileN) throws SQLException, IOException {
        //計算準確率
        ...
        FileWriter fwPrecision = new FileWriter("D:\\OldRecommentAlgorithmWithoutAverage\\1M\\nothird\\Top"+N+"Len"+fileN+"\\Precision.txt", true);
    ...
    private static void printRecall(Map<Integer, List<Integer>> recommentMap,Integer N,Integer fileN) throws SQLException, IOException{
        //計算召回率
    ...
    private static void printNovelty(Map<Integer, List<Integer>> recommentMap,Integer N,Integer fileN) throws SQLException, IOException{
        //計算新新型
    ...
    private static void printCoverage(Map<Integer, List<Integer>> recommentMap,Integer N,Integer fileN) throws SQLException, IOException{
        //計算覆蓋率
    ...
    private static void printILD(Map<Integer, List<Integer>> recommentMap,Integer N,Integer fileN) throws SQLException, IOException{
        //計算ILD
    ...
    private static Map<Integer,Double> Coverage(Map<Integer, List<Integer>> recommentList){
        ...
        while (iterator.hasNext()){
            tempEntry = iterator.next();
            resultMap.put(tempEntry.getKey(),tempEntry.getValue().size()/(totalMovieCount*1.000));
        }
        return resultMap;
    }
    ...
    private static Double CoverageAll(Map<Integer, List<Integer>> recommentList){
        ...
        return movieIdList.size()/(totalMovieCount*1.00);
    }
    ...
    private static void printHD(Map<Integer, List<Integer>> recommentMap,Integer N,Integer fileN) throws SQLException, IOException{
        //計算海明距離
    ...
    private static void printAverageHD(Integer N,Integer fileN) throws IOException{
        //計算平均海明距離
        Map<Integer,Double> averageHD = averageHD(N,fileN);
        ...
        FileWriter fwHd = new FileWriter("D:\\OldRecommentAlgorithmWithoutAverage\\1M\\nothird\\Top"+N+"Len"+fileN+"\\AverageHD.txt", true);
     ...
     *
     */
    private static Map<Integer,Double> averageHD(Integer N,Integer fileN) throws IOException {
        Map<Integer,Double> resultMap = new HashMap<>();
        BufferedReader br = new BufferedReader(new InputStreamReader(new FileInputStream("D:\\OldRecommentAlgorithmWithoutAverage\\1M\\nothird\\Top"+N+"Len"+fileN+"\\HD.txt")));
        String data;
        String tempUserId;
        String tempHD;
