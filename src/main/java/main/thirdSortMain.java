...
public class thirdSortMain {
    ...
    public static void main(String[] args) throws IOException, SQLException {
        //读取文件拿到各用户重排序后的推荐列表
        Map<Integer, List<Integer>> resultMap = readFile();
        for(int i = 1; i <= 4;i ++){
            N = 5 * i;
            switch (N){
                case 5:
            ...
            FileWriter fw = new FileWriter("D:\\OldRecommentAlgorithmWithoutAverage\\100K\\sort\\resultThirdSortTop"+N+".txt", true);
     ...
     * @throws SQLException
     */
    private static Map<Integer, List<Integer>> readFile() throws IOException{
        Map<Integer, List<Integer>> resultMap = new HashMap<>();
        BufferedReader br = new BufferedReader(new InputStreamReader(new FileInputStream("D:\\OldRecommentAlgorithmWithoutAverage\\100K\\sort\\resultAgainSort.txt")));
        String data;
        Integer tempUserId;
        String tempMovieIds;
